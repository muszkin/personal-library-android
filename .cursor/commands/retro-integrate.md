---
description: Doctrine Integration Protocol - Semi-automatic global.mdc updates
alwaysApply: false
---

# Doctrine Integration Protocol

**CRITICAL:** Auto-modification of global.mdc (575+ lines, 51 sections) is **RISKY**. This protocol provides **semi-automatic** integration with safety checks.

**Usage:** Use slash command `/retro-integrate [lesson-id]` in chat after reviewing `.cursor/doctrine-evolution/log.md` to integrate lessons into global.mdc.
...
3. **Locate Integration Point:** Identify exact section in global.mdc using structural analysis:
...
### **Process:**
1. **Create Backup:** Copy global.mdc to `.backup/` before modification
...
1. **Read global.mdc completely** - Understand full context
...
1. **AI Performs Automatic Pre-Check:**
   - Reads global.mdc and evolution log
...
- [ ] **Question:** Is this high-impact enough to justify adding to global.mdc?

#### **B. Logical Coherence & Consistency**

**B1. Conflict Detection:**
- [ ] **Question:** Does this new rule contradict any existing rule in global.mdc?
...
**D3. Tone Consistency:**
- [ ] **Question:** Does the tone match the authoritative, formal style of global.mdc?
...
3. **Human manually applies** diff to global.mdc
